...
const projects = [
  ...
  },
  {
    ...
    githubLink: "https://game-discovery-cq4.vercel.app/",
    description:
  ...
  },
  {
    ...
    languages: ["React", "Next.js", "MongoDB", "Tailwind CSS"],
  },
  {
    ...
    description:
      "I created a budget website that allows users to track their expenses. User can login and add/remove/edit expenses and create/delete/edit budgets. I used MySQL to store the user's data and login info and I used PHP to handle the backend.",
